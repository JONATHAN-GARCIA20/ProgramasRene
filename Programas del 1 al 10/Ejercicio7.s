...
class Program
{
    static void Main()
    {
        try
        {
            ...
            // Inicializar el resultado del factorial como BigInteger para manejar grandes resultados
        ...
        {
            Console.WriteLine("Error: El número es demasiado grande para ser procesado.");
        }
    }
}
...
// Este programa no verifica desbordamiento y calculará el factorial hasta donde los registros lo permitan.
