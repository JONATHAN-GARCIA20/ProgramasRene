...
class Program
{
    ...
    static int Gcd(int a, int b)
    {
        while (b != 0)
        {
            int remainder = a % b; // Calculate a % b
            a = b;                 // Set a to b
            b = remainder;         // Set b to remainder (a % b)
        }
...
// Ejercicio31.s: Función en ensamblador para calcular el MCD de dos números usando el algoritmo de Euclides
