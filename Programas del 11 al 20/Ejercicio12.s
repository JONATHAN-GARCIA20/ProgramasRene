...
class Program
{
    static void Main()
    {
        int[] array = { 5, 3, 8, 1, 2 };  // Sample array
        int length = array.Length;         // Length of the array

        // Display start message
        Console.WriteLine("Buscando el máximo en el arreglo:");
    ...
    // Function to print each element in the array with a space
    ...
    {
        int max = array[0];  // Initialize the maximum with the first element
